import { getConferenceById, deleteParticipantById } from '../connections/connections'
...
export function addParticipantInConference(data) {
  return dispatch => dispatch({ type: ADD_PARTICIPANT, data });
}
